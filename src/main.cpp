                        ...
                        if (event == "telemetry") {
                            ...
                            if (too_close) {
                                ...
                                if (!lane_switch) {
                                    ...
                                    std::cout << "Velocity = " << ref_vel << ", Lane speed =" << lane_speed
                                              << std::endl;
                                } else {
                                    std::cout << "Lane " << lane << ", Velocity = " << ref_vel << std::endl;
                                }
                            }
                            ...
                            if (lane_speed > ref_vel) {
                                ref_vel = min(ref_vel + acceleration,
                                              lane_speed); //Incrase the speed gradually upto 49.5 in case no vehicle in front.
                            } else {
                                ref_vel = max(ref_vel - acceleration,
                                              lane_speed);
                            }
                            //}
